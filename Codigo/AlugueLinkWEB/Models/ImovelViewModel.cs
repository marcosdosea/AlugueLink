...
namespace AlugueLinkWEB.Models
{
    public class ImovelViewModel
    {
        ...
        [Range(0, 10, ErrorMessage = "Número de quartos deve estar entre 0 e 10")]
        public int? Quartos { get; set; }

        [Display(Name = "Banheiros")]
        [Range(0, 10, ErrorMessage = "Número de banheiros deve estar entre 0 e 10")]
        public int? Banheiros { get; set; }

        [Display(Name = "Área (m²)")]
        [Range(0, double.MaxValue, ErrorMessage = "Área deve ser um valor positivo")]
        public decimal? Area { get; set; }

        [Display(Name = "Vagas de Garagem")]
        [Range(0, 10, ErrorMessage = "Número de vagas deve estar entre 0 e 10")]
